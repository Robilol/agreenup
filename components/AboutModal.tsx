                    ...
                    <div className="flex items-center justify-center p-5 sm:p-[50px]">
                        ...
                        >
                            <Dialog.Panel
                                ...
                                <div
                                    className="p-5 pb-20 sm:p-[50px] relative overflow-y-auto max-h-[80vh] sm:max-h-[83vh]"
                                    ref={scrollContent}>
                  <span
                      className="text-primary-50 text-[26px] leading-[36px] sm:text-[38px] sm:leading-[44px] font-sporting-grotesque">Le cheminement d&apos;une vie</span>
                                    <div className="flex flex-col sm:flex-row gap-[50px] mt-5">
                                        <div
                                            className="w-full sm:w-1/3 text-primary-50 text-[18px] leading-[22px] space-y-5 font-light">
                                            <p>Je suis natif de Bar sur Aube (Aube), très jeune mes parents m&apos;ont
                                                initié au jardinage,
                                                j&apos;ai
                                                découvert rapidement ma passion pour l&apos;évolution des plantes et je
                                                recherchais des
                                                challenges
                                                pour les faire pousser le mieux possible comme avec les amaryllis à
                                                faire refleurir. J&apos;ai
                                                un
                                                brevet enseignement professionnel agricole (B.E.P.A) et un B.T.A brevet
                                                technicien agricole
                                                (B.T.A) en productions florales puis j&apos;ai travaillé 16 ans dans les
                                                espaces verts. Je me
                                                suis
                                                formé à l&apos;école de permaculture en micro-ferme à Venansault. La
                                                nature m&apos;a toujours
                                                ressourcé
                                                d&apos;énergies positives.
                                            </p>
                                            <p>
                                                La population a bien pris conscience que la Nature est l&apos;alliée
                                                indispensable à la vie.
                                                Vivre
                                                avec la Nature pour préserver la biodiversité et les futures
                                                générations.
                                                Favoriser les circuits-courts, être en relation avec les cantines des
                                                écoles et les élus des
                                                collectivités pour manger mieux, réduire les coûts des légumes et des
                                                fruits dans le pays de la
                                                gastronomie.
                                            </p>
                                            <p>
                                                J&apos;ai fait une conférence sur le thème « La construction de
                                                l&apos;Avenir en symbiose avec la
                                                nature » à
                                                l&apos;Université Populaire &quot;IDEE UP&quot; à Belfort.
                                            </p>
                                            <p>
                                                Nous pouvons nous nourrir avec des légumes sains qui ont du goût et qui
                                                sont riches en
                                                nutriments avec des méthodes culturales qui utilisent une fertilisation
                                                naturelle en recyclant
                                                les déchets verts.
                                            </p>
                                        </div>
                                        <div
                                            className="w-full sm:w-1/3 text-primary-50 text-[18px] leading-[22px] space-y-5 font-light">
                                            <p>
                                                Le prix de revient est intéressant et leur méthode de conservation
                                                peuvent être variées et est
                                                possible sans énergie aussi. Le temps passé s&apos;oriente surtout sur
                                                les récoltes, seulement
                                                une
                                                préparation du sol la première année avec une méthode culturale adaptée
                                                et suivie permet de
                                                faire travailler à notre place la biodiversité, les artisans des sols...
                                                C&apos;est aussi un plaisir de produire et de manger des légumes que
                                                l&apos;on cuisine!
                                                J&apos;apprécie un proverbe qui est à mon goût, la quintessence de la
                                                vie : &quot;Ne donnes pas
                                                au pêcheur
                                                ...
                                                l&apos;apprentissage de la permaculture avec des élèves provenant des
                                                enseignements généraux et adaptés (SEGPA et ULIS).
                                            </p>
                                        </div>
                    ...
                    <span
                        className="text-primary-50 text-[26px] leading-[36px] sm:text-[38px] sm:leading-[44px] font-sporting-grotesque text-center">La passion de transmettre</span>
                                        <span
                                            className="text-primary-50 text-[22px] leading-[26px] text-center">J&apos;interviens au Centre National de la Fonction Publique<br/>Territoriale où je donne trois stages.</span>
                                    </div>
                                    <div className="flex flex-col sm:flex-row gap-[50px] mt-[50px]">
                                        ...
                                        <div className="w-full sm:w-2/3 gap-[50px] flex flex-col">
                                            <div className="flex flex-col gap-3">
                                                <span
                                                    className="font-bold text-primary-50 text-[18px] leading-[30px] font-sporting-grotesque">La connaissance du fonctionnement écologique des sols en interaction avec les plantes et le climat</span>
                                                <p className="text-primary-50 text-[18px] leading-[22px] font-light">Un
                                                    stage qui résume
                                                    l&apos;ensemble des interactions entre les acteurs de la
                                                    biodiversité des sols en lien avec leurs
                                                    textures, leurs structures et le climat. Les relations entre les
                                                    propriétés physiques,
                                                    biologiques et chimiques des sols comme les amendements et les
                                                    fertilisations naturelles,
                                                    C.A.H, le Ph, le C.E.C, humidifications de la matière organique, le
                                                    potentiel &quot;rédox&quot;. Les
                                                    techniques de régulation de l&apos;eau dans le sol. Les sols
                        ...
                        <span
                            className="font-bold text-primary-50 text-[18px] leading-[30px] font-sporting-grotesque">L&apos;amélioration de la fertilité des sols en espaces verts</span>
                                                <p className="text-primary-50 text-[18px] leading-[22px] font-light">Ce
                                                    stage rappelle les
                                                    besoins nutritifs des végétaux et la connaissance des différents
                                                    milieux physiques, chimiques
                                                    et biologiques. Des analyses de sol sont réalisées avec des méthodes
                                                    de prélèvements.
                                                    Des plans de fumure en amendements et en fertilisation sont intégrés
                                                    et des méthodes
                                                    d&apos;analyses sont réalisées avec l&apos;interprétation des
                                                    résultats.</p>
                                            </div>
                                            <div className="flex flex-col gap-3">
                        <span
                            className="font-bold text-primary-50 text-[18px] leading-[30px] font-sporting-grotesque">L&apos;accompagnement du développement des jardins collectifs</span>
                                                <p className="text-primary-50 text-[18px] leading-[22px] font-light">Les
                                                    objectifs visés sont la
                                                    création des jardins collectifs différents comme les jardins
                                                    pédagogiques, partagés,
                                                    familiaux, solidaires ou d’insertions avec les accompagnements
                                                    techniques (aménagement,
                                                    viabilisation du site, suivi des projets). Les conseils en
                                                    animations horticoles sont basés
                                                    sur les techniques de maraîchage et d’éco-jardinage, les potagers en
                                                    carré en lien avec de la
